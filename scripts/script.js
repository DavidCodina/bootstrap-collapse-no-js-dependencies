//https://jasonbutz.info/2017/11/bootstrap-v4-responsive-navbars-without-jquery/
//https://codepen.io/jasonbutz/pen/yPodOE
...
function handleCollapseElementClick(e) {
  ...
  if (collapseTargetId) {
    ...
    let isShown  = targetEl.classList.contains(CLASS_SHOW)
